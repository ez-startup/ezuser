# Generated by Django 4.2.3 on 2023-07-05 16:07
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('usermanager', '0005_alter_user_groups_alter_user_user_permissions'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('logo', models.ImageField(blank=True, null=True, upload_to='applications/images', verbose_name='logo')),
                ('app_name', models.CharField(blank=True, max_length=255, verbose_name='Application Name')),
                ('application_domain', models.CharField(blank=True, max_length=255, null=True, verbose_name='Application Domain')),
                ...
                ('developer_mail', models.EmailField(blank=True, max_length=250, null=True, verbose_name='Developer E-mail')),
                ('agree', models.BooleanField(default=False, help_text='Check if agree with our terms and conditions', verbose_name='agree')),
